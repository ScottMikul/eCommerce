...
public class CartControllerTest {
	...
	@Test
	public void addTooMuchToPurchaseQuantity() throws Exception {
	...
	@Test
	public void addTooMuchToExistingCart() throws Exception {

		// creating a product to mock. should have a supply of 5.
		Product product = productBuilder();
		product.setQuantity(5);
		product.setId(1L);
		when(productService.findById(1L)).thenReturn(product);

		//should set up a cart with 1 item in it.
		Product product2 = productBuilder();
		product.setQuantity(1);
		product.setId(1L);
		Purchase purchase = purchaseBuilder(product2);
		when(sCart.getPurchase()).thenReturn(purchase);
	...
	@Test
	public void updatePurchaseQuantityPastQuantityShouldThrowError() throws Exception {
		when(sCart.getPurchase()).thenReturn(new Purchase());
